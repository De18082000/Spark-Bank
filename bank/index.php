...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\sparks.jpg" alt=""
                    style="height: 80px; margin-left:25px; margin-top:10px; border-radius:40px"></a>
    ...
    <div class="container-large"
        style="color:lightyellow; height:350px; width: 100%; padding:8% 2% 2% 2%; background-color:#212529;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size : 60px;text-shadow:3px 3px 3px #ffffb3; text-align:center; color:#ff9933;"><b>Welcome to <br> Online Banking!!!!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/money2.jpg" class="zoomin" alt="" style="border-radius:1220px">
            </div>
        </div>
    </div>
    <img  alt="" style="width:100%; position:absolute; z-index:-1">
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:#d1d1e0;"><b>Facilities Available</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#3d3d5c; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
