...
<body style="background-color:#212529; padding-top:8%;">
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div
                style="width:50%; background-color:#cccc00; padding:5px 5px 5px 5px; border-radius:10px; box-shadow: 2px 2px 10px grey;">
            ...
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px;  ">
                <form action="send_money.php" method="post">
                    ...
                    <p style="color:white;">View Account Balance <a href="check_blc.php">here</a></p>
                </form>
            </div>
        </div>
