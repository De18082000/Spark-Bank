...
<body style="background-color:#212529;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:50%; background-color:#cccc00; padding:5px 5px 5px 5px; border-radius:10px; box-shadow: 2px 2px 10px lightblue;">
                <h1 style=" color:black;">About Us</h1>
            </div>
            <br><br>
            <p style="color:white;">Designed by-</p>
            <h1 style="color:white; text-shadow:2px 2px 2px blue;">Deeksha Rani B N</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br>CMR Institute of Technology,Bangalore<br>email-deekshanagesh18@gmail.com</b></p>
    </center>
