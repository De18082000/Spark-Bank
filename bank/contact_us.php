...
<body style="background-color:#343a40; padding-top:8%;">
...
?>
    ...
    <style>
        ...
        .mybtn {
            margin-bottom: 10px;
            box-shadow: 2px 2px 10px #ffff1a;
            border-radius: 30px;
            font-weight: bold;
            color: pink;
        }
    ...
    <center>
        <div class="container" style="padding:10px 80px 10px 80px; margin-top:2%;">
            <div
                style="width:50%; background-color:#cccc00; padding:5px 5px 5px 5px; border-radius:10px; box-shadow: 2px 2px 10px gray;">
            ...
            <div class="container"
                ...
                <form action="contact_us.php" method="post">
                    ...
                    <textarea name="message" class="" style="border-radius:10px; padding: 5px 5px 5px 15px; width:450px"
